...
class TestAdiabatic(unittest.TestCase):
    def test_bir4(self):
        ...
        kappa = np.arctan(20)
        flip = np.pi / 4
        [am_bir, om_bir] = adiabatic.bir4(n, beta, kappa, flip, dw0)
    ...
    def test_hyp_ex(self):
        ...
        mu = 4.9
        dur = 0.012
        [am_sech, om_sech] = adiabatic.hypsec(n, beta, mu, dur)
    ...
    def test_goia_wurst(self):
        ...
        n_b1 = 16
        m_grad = 4
        [_, om_goia, g_goia] = adiabatic.goia_wurst(n, dur, f, n_b1, m_grad)
